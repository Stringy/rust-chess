...
fn main() {
    ...
    println!(
        "const CLASSIC_WHITE_PAWNS: Bitboard   = {:X?};",
        white_pawns
    );
    println!(
        "const CLASSIC_WHITE_ROOKS: Bitboard   = {:X?};",
        white_rooks
    );
    println!(
        "const CLASSIC_WHITE_KNIGHTS: Bitboard = {:X?};",
        white_knights
    );
    println!(
        "const CLASSIC_WHITE_BISHOPS: Bitboard = {:X?};",
        white_bishops
    );
    println!(
        "const CLASSIC_WHITE_QUEEN: Bitboard   = {:X?};",
        white_queen
    );
    println!("const CLASSIC_WHITE_KING: Bitboard    = {:X?};", white_king);

    println!(
        "const CLASSIC_BLACK_PAWNS: Bitboard   = {:X?};",
        black_pawns
    );
    println!(
        "const CLASSIC_BLACK_ROOKS: Bitboard   = {:X?};",
        black_rooks
    );
    println!(
        "const CLASSIC_BLACK_KNIGHTS: Bitboard = {:X?};",
        black_knights
    );
    println!(
        "const CLASSIC_BLACK_BISHOPS: Bitboard = {:X?};",
        black_bishops
    );
    println!(
        "const CLASSIC_BLACK_QUEEN: Bitboard   = {:X?};",
        black_queen
    );
